...
ITEM.name = "Romanova Contraceptive Implant";
ITEM.cost = 10;
...
ITEM.business = false;
ITEM.description = "Simple implant to release contraceptives into the body regularly until removed. Comes in male/female models.";
