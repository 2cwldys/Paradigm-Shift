...
ITEM.business = false;
ITEM.description = "An autocompensating chip is placed in the cyberoptics which greatly reduces the effects of glare, flashes, strobes, etc.";
