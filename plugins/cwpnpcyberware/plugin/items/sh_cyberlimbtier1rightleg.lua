...
ITEM.name = "Active Cyberleg [Right leg]";
ITEM.cost = 450;
...
ITEM.business = false;
ITEM.description = "Armor [1] Wounding [2] +1 Dodge, Artificial limb replacement, metal arm structure with artificial muscles. Styles vary. Can hold 1 upgrade. Double strength of an average man.";
