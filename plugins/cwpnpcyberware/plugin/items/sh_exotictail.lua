...
ITEM.business = false;
ITEM.description = "Unique tail that can move at the user's command. OOC: Collect all 3 and you can do a full-body exotic biosculpt for aesthetic purposes";
