...
ITEM.business = false;
ITEM.description = "A hydraulic spike that lodges itself into the ground to stabilize the user, nullifying any attempted tackles. Cannot be used as a weapon.";
