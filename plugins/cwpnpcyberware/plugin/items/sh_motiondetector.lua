...
ITEM.name = "Zetatech Motion Detector";
ITEM.cost = 75;
...
ITEM.business = false;
ITEM.description = "Nullifies Sneak Attacks. Device implanted in the user's skull allowing the user to sense vague movements all around them.";
