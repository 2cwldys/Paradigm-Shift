...
ITEM.name = "Militech Quickdraw Holster";
ITEM.cost = 50;
...
ITEM.business = false;
ITEM.description = "[Illegal] +1 Reflexes, A mechanized holster built into a limb to conceal and quickly draw/eject a small weapon such as a pistol or knife into the user's grip. (You can fluff having two for akimbo.)";
