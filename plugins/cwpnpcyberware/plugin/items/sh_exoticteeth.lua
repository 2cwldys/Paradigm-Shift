...
ITEM.business = false;
ITEM.description = "Unique teeth which replace the user's own teeth. OOC: Collect all 3 and you can do a full-body exotic biosculpt for aesthetic purposes";
