...
ITEM.name = "Liberty Arms Tactical Flasher";
ITEM.cost = 100;
...
ITEM.business = false;
ITEM.description = "[Legal: C-1] Once per combat, single target. An extremely bright strobe of light emitted forward from the finger at a target to blind them.";
