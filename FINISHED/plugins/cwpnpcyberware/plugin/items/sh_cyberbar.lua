...
ITEM.business = false;
ITEM.description = "A minibar stocked with glasses, drinks (on tap), a dish towel, and bottle/cork opener. Comes in many branded designs all licensed by Neodivat";
