...
ITEM.name = "Dakai QuickClot Endothelium";
ITEM.cost = 350;
...
ITEM.business = false;
ITEM.description = "This modifies the endothelium surrounding blood vessels to produce much more collagen when broken, causing blood coagulation to be near instant. This prevents nearly all possible blood loss.";
