...
ITEM.name = "Arasaka Stressmaster";
ITEM.cost = 50;
...
ITEM.business = false;
ITEM.description = "A chemical modification to the amygdala decreases the amount of stress hormones it orders glands to produce. Artificial bravery.";
