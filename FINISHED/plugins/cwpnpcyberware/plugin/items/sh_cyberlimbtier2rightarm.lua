...
ITEM.name = "Precise Cyberarm [Right arm]";
ITEM.cost = 450;
...
ITEM.business = false;
ITEM.description = "Armor [1] Wounding [2] +1 Firearms, Artificial limb replacement, metal arm structure with artificial muscles. Styles vary. Can hold 1 upgrade. Double strength of an average man.";
