...
--RECIPE:Register();
--Uncomment the RECIPE:Register() in actual recipes, this is just to prevent the example recipe from being added
...
As a station is a CW item and has to be on the map, they can be destroyed, picked-up etc.
