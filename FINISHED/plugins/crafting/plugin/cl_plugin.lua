...
Clockwork.flag:Add("S", "Superior Sewing", "Access to superior sewing recipes.");
Clockwork.flag:Add("A", "Advanced Crafting", "Access to advanced crafting recipes.");
Clockwork.flag:Add("E", "Exotic Crafting", "Access to the most exotic recipes.");
