...
function PLUGIN:CalcView(client, origin, angles, fov)
	...
	if (IsValid(viewEntity) and Schema:IsPlayerCombineRank(LocalPlayer(), "SCN")) then
		local view = {}
...
function PLUGIN:HUDPaint()
	...
	if (Schema:IsPlayerCombineRank(LocalPlayer(), "SCN") and !LocalPlayer():GetNetworkedVar("CamMode", true)) then
...
hook.Add("PostRender", "ScannerScreenshotCapture", function()
	if (!takeScreenshot) then return; end;
