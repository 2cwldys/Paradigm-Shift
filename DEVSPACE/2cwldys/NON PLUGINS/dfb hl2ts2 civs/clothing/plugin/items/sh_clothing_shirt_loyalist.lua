...
ITEM.name = "Laboratory Shirt";
ITEM.model = "models/tnb/items/shirt_citizen2.mdl";
ITEM.skin = 2;
ITEM.weight = 1;
ITEM.useText = "Wear Shirt";
ITEM.category = "Clothing";
ITEM.description = "A comfortable looking white shirt with a series of identification numbers of it's front pocket.";
