...
ITEM.name = "Nu-Tek Flashlight Socket";
ITEM.cost = 10;
...
ITEM.business = false;
ITEM.description = "Flashlight socket embedded in the user's body. Styles include: Pop-up and Concealed. Flashlight not included.";
