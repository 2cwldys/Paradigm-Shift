...
ITEM.name = "Exotic Ears";
ITEM.cost = 25;
ITEM.model = "models/Items/battery.mdl";
ITEM.weight = 0;
ITEM.useText = "Activate";
ITEM.category = "C-Exotic Cyberware";
ITEM.business = false;
ITEM.description = "Unique ears that can move at the user's command and/or function in the place of normal ears. OOC: Collect all 3 and you can do a full-body exotic biosculpt for aesthetic purposes";
