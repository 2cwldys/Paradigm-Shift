...
ITEM.business = false;
ITEM.description = "Filters installed in the nose, mouth, and lungs. Blocking out the effects of harmful substances such as mace, tear gas, pepperspray, etc.";
